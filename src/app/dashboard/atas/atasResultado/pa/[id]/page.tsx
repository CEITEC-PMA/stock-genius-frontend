        ...
        <div id="content-id">
          <Box display="flex" flexDirection="column" component={Paper}>
            ...
            <Box mt={1} component={Paper} textAlign="center" mx={1} mb={1}>
              ...
              <Box mt={4} mb={2}>
                <Typography variant="h6">
                  Comparecimento de eleitores conforme lista de votantes
                </Typography>
              </Box>

              <Box mb={4}>
                <TabelaAlunosVotantes
                  qtdAlunosConstantes={qtdAlunosConstantes}
                  qtdAlunosCompareceram={qtdAlunosCompareceram}
                  qtdAlunosNaoCompareceram={qtdAlunosNaoCompareceram}
                />
              </Box>

              <Box mb={4}>
                <TabelaResponsaveisAlunosVotantes
                  ...
                  qtdRespAlunosVotantesNaoCompareceram={
                    qtdRespAlunosVotantesNaoCompareceram
                  }
                />
              </Box>
              ...
              <Box>
                <TabelaResponsaveisAlunosNaoVotantes
                  ...
                  qtdRespAlunosNaoVotantesNaoCompareceram={
                    qtdRespAlunosNaoVotantesNaoCompareceram
                  }
                />
              </Box>
