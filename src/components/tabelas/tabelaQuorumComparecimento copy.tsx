...
export default function TabelaQuorumComparecimento({ totalVotos,
    qtdAlunosConstantes,
        ...
        <Table sx={{ border: '1px solid black' }}>
            ...
            <TableBody>
                ...
                <TableRow>
                    ...
                    <TableCell sx={{ border: '1px solid black', textAlign: 'center' }}><Typography>{qtdAlunosConstantes === 0 ? 0 : qtdAlunosCompareceram / qtdAlunosConstantes * 100} %</Typography>  </TableCell>
                    <TableCell sx={{ border: '1px solid black', textAlign: 'center' }}><Typography> {qtdRespAlunosNaoVotantesConstantes}</Typography>  </TableCell>
                    <TableCell sx={{ border: '1px solid black', textAlign: 'center' }}><Typography>{Math.round(qtdRespAlunosNaoVotantesCompareceram / qtdRespAlunosNaoVotantesConstantes * 100)} % </Typography> </TableCell>
                    <TableCell sx={{ border: '1px solid black', textAlign: 'center' }}><Typography>{qtdRespAlunosVotantesConstantes}</Typography> </TableCell>
                    <TableCell sx={{ border: '1px solid black', textAlign: 'center' }}><Typography>{qtdAlunosConstantes === 0 ? 0 : qtdAlunosCompareceram / qtdAlunosConstantes * 100} %</Typography> </TableCell>
                    <TableCell sx={{ border: '1px solid black', textAlign: 'center' }}><Typography> </Typography> {qtdFuncionariosConstantes} </TableCell>
                    <TableCell sx={{ border: '1px solid black', textAlign: 'center' }}><Typography> {Math.round(qtdFuncionarosCompareceram / qtdFuncionariosConstantes * 100)} % </Typography>  </TableCell>
