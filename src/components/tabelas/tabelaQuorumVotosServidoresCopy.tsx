...
export default function TabelaQuorumServidoresCopy({
  dadosQuorum,
}: ITabelaQuorumServidores) {
  const qtdFuncionarios = dadosQuorum?.map((quorum) => {
    return quorum.votosFuncionarios;
  });

  const somaQtdFuncionarios = qtdFuncionarios?.reduce(
          ...
          <Table sx={{ border: "1px solid black" }}>
            <TableHead>
              <TableRow>
                ...
                >
                  <Typography>Total Votos Funcionarios</Typography>{" "}
                </TableCell>
              </TableRow>
            </TableHead>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                >
                  <Typography>
                    TOTAL VOTOS VÁLIDOS SEGMENTO PROFESSORES E SERVIDORES
                    ADMINISTRATIVO: {somaQtdFuncionarios}
                  </Typography>
                </TableCell>
              </TableRow>
            </TableBody>
